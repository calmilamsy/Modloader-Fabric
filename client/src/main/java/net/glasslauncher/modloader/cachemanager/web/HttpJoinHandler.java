...
import net.glasslauncher.modloader.jsontemplate.JoinRequest;
import net.glasslauncher.modloader.jsontemplate.Profile;
    ...
    public static String getResponse(URL url) {
        try {
            ...
            */
            ...
            PrintWriter outputStream = new PrintWriter(Minecraft.getMinecraftDir() + "test.json");
